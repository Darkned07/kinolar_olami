    ...
    <main className="max-container">
      <div className="flex  place-content-center w-full border  border-secondary rounded-xl  py-5 px-2">
        <div className="flex flex-col gap-3 items-center justify-center">
          ...
          <span className="flex flex-wrap gap-1 font-bold items-center justify-center">
            Karta raqam: <p className="font-normal">9860 2301 0863 3077</p>
          </span>
          <span className="flex flex-wrap gap-1 font-bold items-center justify-center">
            Payer hamyon raqam: <p className="font-normal">P1081517853</p>
          </span>
        </div>
      </div>
    </main>
